...
$data = mySQLquery("SELECT * FROM plants WHERE plantID ='$new'");
    ...
    { 
        ...
        echo ("<td><input type= 'text' name= 'variety' value= 'varietal'></td>");
        echo ("<td><input type= 'number' name= 'numf' value= '1'></td>");
        echo ("<td><input type= 'date' name= 'germf' placeholder= 'date germinated'></td>");
        echo ("<td><input type= 'date' name= 'transplantf' placeholder= 'date in the garden'></td>");
        echo ("<td><input type= 'text' name= 'catf' value= 'Catalogue number'></td>");
